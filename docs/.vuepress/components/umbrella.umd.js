(function (global, factory) {
  ...
  (global = global || self, global.umbrella = factory(global.Vue));
  ...
  function registerHooks(name, fn) {
    vm.$options[name] = vm.$options[name] || [];
    vm.$options[name].push(fn);
  }

  var state = Vue.observable;
  var onCreated = function onCreated(fn) {
    return registerHooks('created', fn);
  };
  var onUnMounted = function onUnMounted(fn) {
    return registerHooks('destroy', fn);
  };
  var onMounted = function onMounted(fn) {
    return registerHooks('mounted', fn.bind(null, vm.$refs));
  };
  function createComponent(options) {
    ...
    var component = _objectSpread({}, options, {
      beforeCreate: function beforeCreate() {
        vm = this;

        if (typeof options === 'function') {
          this.$options.inheritAttrs = false;
          this.$options.render = options(_objectSpread({
            vm: this
          }, o));
        } else {
    ...
    setup: function setup() {
      ...
      return function () {
        var disabled = _this.disabled,
            ...
            circle = _this.circle,
            icon = _this.icon;
        var classs = ['el-button', type ? 'el-button--' + type : '', size ? 'el-button--' + size : '', {
